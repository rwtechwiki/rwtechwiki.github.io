...
---
In order to contribute to the wiki, the first thing you will need is [Obsidian](https://obsidian.md/download).

Next you will need a Github account (very easy to [set up](https://github.com/signup)).

You will also need some kind of Git interface, if you are familiar with Git, you can move along, otherwise we recommend [TortoiseGit](https://tortoisegit.org/download/) and [Git for Windows](https://gitforwindows.org/).

1. Go to the GitHub repository and in the top right, click "Fork". This will create a version of the repository that you can work with
...
4. Now you can create, delete or modify files to build the wiki (information for understanding the wiki structure can be found [here](wikistructure.md) as well as how to add new entries [here](newnotes.md))
...
9. Make sure that the selected repositories below "Compare changes" look like this: rwtechwiki/wiki|main <- MyUsername/wiki|main
